...
class ReceipesControllerTest < ActionController::TestCase
  ...
  test "should create receipe" do
    assert_difference('Receipe.count') do
      post :create, receipe: { country: @receipe.country, direction: @receipe.direction, preperation_time: @receipe.preperation_time, servings: @receipe.servings, title: @receipe.title }
    end
  ...
  test "should update receipe" do
    patch :update, id: @receipe, receipe: { country: @receipe.country, direction: @receipe.direction, preperation_time: @receipe.preperation_time, servings: @receipe.servings, title: @receipe.title }
    assert_redirected_to receipe_path(assigns(:receipe))
  end
